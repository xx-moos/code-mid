    ...
    public void del(String... key) {
        if (key != null && key.length > 0) {
            if (key.length == 1) {
                ...
                redisTemplate.delete((Collection<String>) new HashSet<>(Arrays.asList(key)));
            }
        }
    }
